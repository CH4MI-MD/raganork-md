...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "CH4MI-MD",
    BOT_NAME: process.env.BOT_NAME || 'CH4MI-MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶCHAMI¹¹ꫂ;CH4MI MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
